/**
 * WSImportSignedDocumentbindingStub.java
 *
...
public class WSImportSignedDocumentbindingStub extends org.apache.axis.client.Stub implements ru.masterdm.uct.axis.ws.WSImportSignedDocument {
    ...
    static {
        ...
        oper.setName("ImportSignedDocument");
        ...
        oper.addParameter(new javax.xml.namespace.QName("", "SignData"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, org.apache.axis.description.ParameterDesc.IN, false, false);
    ...
    public WSImportSignedDocumentbindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public WSImportSignedDocumentbindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public WSImportSignedDocumentbindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public void importSignedDocument(javax.xml.rpc.holders.StringHolder BSError, javax.xml.rpc.holders.StringHolder BSErrorCode, int custID, java.lang.String docData, java.lang.String docScheme, int docVersion, javax.xml.rpc.holders.StringHolder recordID, java.lang.String remoteUser, java.lang.String signData) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("urn:WSImportSignedDocumentIntf-WSImportSignedDocument#ImportSignedDocument");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:WSImportSignedDocumentIntf-WSImportSignedDocument", "ImportSignedDocument"));

        setRequestHeaders(_call);
        setAttachments(_call);
        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {BSError.value, BSErrorCode.value, new java.lang.Integer(custID), docData, docScheme, new java.lang.Integer(docVersion), recordID.value, remoteUser, signData});
