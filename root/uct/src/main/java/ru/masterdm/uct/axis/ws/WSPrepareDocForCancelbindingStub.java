/**
 * WSPrepareDocForCancelbindingStub.java
 *
...
public class WSPrepareDocForCancelbindingStub extends org.apache.axis.client.Stub implements ru.masterdm.uct.axis.ws.WSPrepareDocForCancel {
    ...
    static {
        ...
        oper.setName("PrepareDocForCancel");
        ...
        oper.addParameter(new javax.xml.namespace.QName("", "CancelFields"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, org.apache.axis.description.ParameterDesc.INOUT, false, false);
    ...
    public WSPrepareDocForCancelbindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public WSPrepareDocForCancelbindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public WSPrepareDocForCancelbindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public void prepareDocForCancel(javax.xml.rpc.holders.StringHolder BSError, javax.xml.rpc.holders.StringHolder BSErrorCode, javax.xml.rpc.holders.StringHolder cancelFields, int custID, java.lang.String docScheme, java.lang.String recordID, java.lang.String remoteUser) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("urn:WSPrepareDocForCancelIntf-WSPrepareDocForCancel#PrepareDocForCancel");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:WSPrepareDocForCancelIntf-WSPrepareDocForCancel", "PrepareDocForCancel"));

        setRequestHeaders(_call);
        setAttachments(_call);
        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {BSError.value, BSErrorCode.value, cancelFields.value, new java.lang.Integer(custID), docScheme, recordID, remoteUser});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                cancelFields.value = (java.lang.String) _output.get(new javax.xml.namespace.QName("", "CancelFields"));
            } catch (java.lang.Exception _exception) {
                cancelFields.value = (java.lang.String) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("", "CancelFields")), java.lang.String.class);
            }
        }
    }
