/**
 * WSGetFreeBankDocsGOZbindingStub.java
 *
...
public class WSGetFreeBankDocsGOZbindingStub extends org.apache.axis.client.Stub implements ru.masterdm.uct.axis.ws.WSGetFreeBankDocsGOZ {
    ...
    static {
        ...
        oper.setName("GetFreeBankDocGOZ");
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("GetFreeBankDocGOZList");
        oper.addParameter(new javax.xml.namespace.QName("", "BSError"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, org.apache.axis.description.ParameterDesc.INOUT, false, false);
        oper.addParameter(new javax.xml.namespace.QName("", "BSErrorCode"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, org.apache.axis.description.ParameterDesc.INOUT, false, false);
        oper.addParameter(new javax.xml.namespace.QName("", "CustID"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, org.apache.axis.description.ParameterDesc.IN, false, false);
    ...
    public WSGetFreeBankDocsGOZbindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public WSGetFreeBankDocsGOZbindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public WSGetFreeBankDocsGOZbindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public void getFreeBankDocGOZ(javax.xml.rpc.holders.StringHolder BSError, javax.xml.rpc.holders.StringHolder BSErrorCode, int custID, javax.xml.rpc.holders.StringHolder document, java.lang.String recordID, java.lang.String remoteUser, javax.xml.rpc.holders.StringHolder signData) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("urn:WSGetFreeBankDocsGOZIntf-WSGetFreeBankDocsGOZ#GetFreeBankDocGOZ");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:WSGetFreeBankDocsGOZIntf-WSGetFreeBankDocsGOZ", "GetFreeBankDocGOZ"));
    ...
    public void getFreeBankDocGOZList(javax.xml.rpc.holders.StringHolder BSError, javax.xml.rpc.holders.StringHolder BSErrorCode, int custID, javax.xml.rpc.holders.StringHolder docList, java.util.Date documentDate, java.lang.String remoteUser) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("urn:WSGetFreeBankDocsGOZIntf-WSGetFreeBankDocsGOZ#GetFreeBankDocGOZList");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:WSGetFreeBankDocsGOZIntf-WSGetFreeBankDocsGOZ", "GetFreeBankDocGOZList"));
